...
export default function HospitalDashboard() {
    ...
    const getTabStyle = (tab) => ({
        ...
        color: activeTab === tab ? '#10b981' : '#cbd5e1',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#f8fafc', overflow: 'hidden' }}>
            ...
            <header style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', width: '260px' }}>
                    <div style={{ background: '#10b981', padding: '0.5rem', borderRadius: '0.5rem' }}>🏥</div>
                    <div>
                        <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 'bold' }}>Vediere Central</h2>
                        <span style={{ fontSize: '0.75rem', color: '#94a3b8' }}>Hospital Admin Control</span>
                    </div>
                </div>
                ...
                <main style={{ flex: 1, padding: '2rem', overflowY: 'auto' }}>
                    ...
                    {activeTab === 'overview' && (
                        <div className="fade-in">
                            <h1 style={{ fontSize: '1.5rem', color: '#0f172a', marginBottom: '1.5rem', fontWeight: 'bold' }}>Hospital Operations Overview</h1>
                            ...
                            <div style={{ background: 'white', borderRadius: '0.75rem', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', overflow: 'hidden' }}>
                                <table style={{ width: '100%', textAlign: 'left', borderCollapse: 'collapse' }}>
                                    ...
                                    <tbody>
                                        ...
                                        {claims.length === 0 && <tr><td colSpan="4" style={{ padding: '2rem', textAlign: 'center', color: '#64748b' }}>Awaiting initial hospital claim submission.</td></tr>}
                                    </tbody>
                                </table>
                            </div>
                        </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                                <div style={{ background: 'white', padding: '2rem', borderRadius: '0.75rem', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                        <input type="text" defaultValue="City Central Hospital" style={{ padding: '0.75rem', border: '1px solid #e2e8f0', borderRadius: '0.5rem', outline: 'none' }} />
